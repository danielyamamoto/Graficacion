...
void Application::setup() {
	eye = glm::vec3(0.0f, 30.0f, 100.0f);
	...
	loadShaders();
	plane.texture_id[0] = multiTexture("europeHeightmap.jpg");	// HeightMap
	plane.texture_id[1] = multiTexture("europeColor.png");		// ImgColor
	//plane.texture_id[0] = multiTexture("fbBW.jpg");	// HeightMap
	//plane.texture_id[1] = multiTexture("fbC.jpg");	// ImgColor
	...
	plane.uTexture[0] = glGetUniformLocation(plane.shader, "theTexture0"); // HeightMap
	plane.uTexture[1] = glGetUniformLocation(plane.shader, "theTexture1"); // ImgColor
...
void Application::update() {
	plane.fAngleY = plane.fAngleY + 1.0f; // PC
