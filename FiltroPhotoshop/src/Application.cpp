...
void Application::setup() {
	...
	plane.texture_id[2] = multiTexture("heightMap.png");
	...
	plane.uTexture[2] = glGetUniformLocation(plane.shader, "theTexture2"); // HeightMap
...
void Application::display() {
	...
	// Texture 2 HeightMap
	glBindTexture(GL_TEXTURE_2D, plane.texture_id[2]);
	glUniform1i(plane.uTexture[2], 2);
